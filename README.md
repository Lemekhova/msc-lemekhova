...
В работе исследовано влияние параметров PEFT-методов (LoRA, QLoRA, OrthoGeoLoRA) на качество и вычислительную эффективность языковых моделей при классификации коротких текстов в условиях ограниченных ресурсов. Выявленные в результате завиимотсти и закономерности позволяют выбирать оптимальные конфигурации без полного перебора параметров.

[Официальная публикация работы](https://www.hse.ru/edu/vkr/1160980184)
