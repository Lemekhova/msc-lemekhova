...
В работе исследовано влияние параметров PEFT-методов (LoRA, QLoRA, OrthoGeoLoRA) на качество и вычислительную эффективность языковых моделей при классификации коротких текстов в условиях ограниченных ресурсов. На основе 934 экспериментов установлено, что объём выборки (порог 1500 образцов на класс) — ключевой фактор качества, конфигурация q+v даёт лучший баланс затрат и эффективности, влияние ранга и модулей на память и время носит аддитивный характер, а их выбор зависит от объема выборки и т.д. Результаты позволяют выбирать оптимальные конфигурации без полного перебора параметров.
